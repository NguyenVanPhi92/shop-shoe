const productTutorial = [
  {
    title: 'Các bước mua hàng mua hàng',
    content:
  ...
  },
  {
    ...
    content:
      'Chất liệu: Canva Giới tính: Men, Women Độ cao đế: 5cm Sản xuất tại: Việt Nam Hút mắt với hình ảnh mặt cười ngộ nghĩnh được biến tấu dưới dạng chữ Converse cực xịn xò. Gam màu xanh “so fresh” mix cùng form dáng cổ cao năng động cho bạn có được những outfit thời trang. - Thân giày với chất liệu vải canvas êm thoáng - Phối màu đốt mắt tạo điểm nhấn cho outfit - Tạo hình dòng chữ Converse làm mặt cười cùng hai ngôi sao hình cặp mắt sáng tạo - Các nút xỏ dây giày kim loại bóng loáng tạo độ thoáng - Logo bên hông thân giày, lưỡi gà, gót giày có tính biểu tượng - Quy cách đóng gói: Double Box - Thời gian bảo hành: 1 tháng',
  },
];
